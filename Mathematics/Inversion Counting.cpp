...
//	If, from any permutation, another is formed by interchanging two elements, then the difference between the number of inversions in the two is always an odd number.

//	Spoj - INVCNT
//	Using merge sort, BIT, Set(inefficient)
